...
Если подписок нет, бот сохраняет анкету и показывает кнопку повторной проверки подписок.
После успешной записи бот отправляет пользователю ссылку на таблицу.
